...
import (
	...
	bankapi "github.com/ardanlabs/smartcontract/app/bank/proxy/contract/go/api/v3"
...
func run() (err error) {
	...
	if err := os.WriteFile("zarf/tmp/.BANK_API_V3_CONTRACT_ID", []byte(address.Hex()), 0644); err != nil {
		return fmt.Errorf("exporting BANK_API_V3_CONTRACT_ID file: %v\n", err)
	}
